...
toast.success("Long message", "success", 10000);
```
...
toast.error("Critical error!", "error", 5000); 
```

> [!TIP]
> Use shorter durations for simple notifications and longer durations for critical errors that require user attention.
